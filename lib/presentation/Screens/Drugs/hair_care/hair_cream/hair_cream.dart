...
class hair_cream extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_lang.gethaircream(),style: TextStyle(fontSize: 20),),
      ),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/هيمالايا كريم .jpg'),width: 120,height: 120,),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/بالمرز.jpg'),width: 120,height: 120,),
                        Text(
                            'بالمرز هيرفود ضد القشره 150 جم '),
                        Text(
                          'برطمان',style: TextStyle(color: Colors.grey[300]),),
                        Text(
                            '93 جنيه'),
                        Container(
                          decoration: BoxDecoration(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/هيركود.jpg'),width: 120,height: 120,),
                        Text(
                            'هيركود جل ويت لوك 100 مل'),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/سيروبايب.jpg'),width: 120,height: 120,),
                        Text(
                            'سيروبايب سيرم لشعر 100 مل '),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image(
                          image: AssetImage('images/بالمرز ستايلنج .jpg'),width: 120,height: 120,),
                        Text(
                            '    بالمرز ستايلنج جل سترونج هولد 150 جرام   '),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/بانتين برو.jpg'),width: 120,height: 120,),
                        Text(
