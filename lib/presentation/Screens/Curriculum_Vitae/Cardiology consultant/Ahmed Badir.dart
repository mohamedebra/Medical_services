...
import 'package:medical_services/presentation/Screens/chat/chats_doctors/cardiology_consultant/Ahmed_Badir_chat.dart';
import 'package:medical_services/presentation/Screens/reservation/reservation_Cardiology_consultant/Ahmed_Badir.dart';


class Ahmed_Badir extends StatelessWidget {
  const Ahmed_Badir({Key? key}) : super(key: key);
                ...
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: CircleAvatar(
                        radius: 45,
                        backgroundImage: AssetImage('images/Ahmed Badir.jpg'),
                      ),
                    ),
                    SizedBox(height: 5,),
                    Text('Dr ,  Ahmed Badir',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                    SizedBox(height: 5,),
                    ...
                    children: [
                      Expanded(child: Row(
                        children: [
                          ...
                          Column(
                            children: [
                              Text('42+',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black87,fontSize: 20),),
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Ahmed_Badir_chat()));
                            ...
                            CircleAvatar(
                              ...
                              backgroundColor: Colors.blue,
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Reservation_Ahmed_Badir()));
