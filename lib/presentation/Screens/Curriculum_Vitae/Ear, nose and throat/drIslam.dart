...
import 'package:medical_services/presentation/Screens/chat/chats_doctors/ear,nose/drIslam_chat.dart';
import 'package:medical_services/presentation/Screens/reservation/reservation_Ear,%20nose%20and%20throat/reservation_Dr_islam.dart';


class Dr_Islam extends StatelessWidget {
  const Dr_Islam({Key? key}) : super(key: key);
                ...
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: CircleAvatar(
                        radius: 45,
                        backgroundImage: AssetImage('images/اسلام محمد.jpg'),
                      ),
                    ),
                    SizedBox(height: 5,),
                    Text('Dr ,    Islam Mohammed',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                    SizedBox(height: 5,),
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => DrIslam_chat()));
                            ...
                            CircleAvatar(
                              ...
                              backgroundColor: Colors.blue,
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Reservation_Dr_Islam()));
