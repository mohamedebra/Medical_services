...
import 'package:medical_services/presentation/Screens/chat/chats_doctors/ear,nose/drMohamed_chat.dart';
import 'package:medical_services/presentation/Screens/reservation/reservation_Ear,%20nose%20and%20throat/reservation_Dr_mohamed.dart';


class Dr_Mohamed extends StatelessWidget {
  const Dr_Mohamed({Key? key}) : super(key: key);
                ...
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: CircleAvatar(
                        radius: 45,
                        backgroundImage: AssetImage('images/محمد رفعت.jpg'),
                      ),
                    ),
                    SizedBox(height: 5,),
                    Text('Dr ,    Mohamed Refaat',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                    SizedBox(height: 5,),
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => DrMohamed_chat()));
                            ...
                            CircleAvatar(
                              ...
                              backgroundColor: Colors.blue,
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Reservation_Dr_Mohamed()));
