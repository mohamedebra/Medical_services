            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  Padding(
                    padding:
                        const EdgeInsets.only(left: 25, top: 30, bottom: 30),
                    child: Container(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                        'Used it for 1 month only. the way it is \n displayed and the way information is \n given is very good')
                  ],
                )
              ],
            ),
