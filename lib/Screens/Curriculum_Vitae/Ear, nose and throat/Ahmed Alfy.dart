...
import 'package:medical_services/Screens/chat/chats_doctors/ear,nose/Ahmed_Alfy_chat.dart';
import 'package:medical_services/Screens/reservation/reservation_Ear,%20nose%20and%20throat/reservattion_Dr_Ahmed_Alfy.dart';
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5,),
                    Text('Dr ,    Ahmed Alfy',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                    SizedBox(height: 5,),
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Ahmed_Alfy_chat()));
                            ...
                            CircleAvatar(
                              ...
                              backgroundColor: Colors.blue,
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Reservation_Dr_Ahmed_Alfy()));
