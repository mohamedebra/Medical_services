...
import 'package:medical_services/Screens/chat/chats_doctors/orthopedic/Muhammad_Abul_Majd_chat.dart';
import 'package:medical_services/Screens/reservation/reservation_Cardiology_consultant/reservation_ahmed_fathi.dart';
import 'package:medical_services/Screens/reservation/reservation_Orthopedic/Muhammad_Abul_Majd_resevation.dart';
                ...
                Column(
                  ...
                  children: const [
                    Padding(
                      ...
                      child: CircleAvatar(
                        radius: 45,
                        backgroundImage: AssetImage('images/محمد ابو المجد.jpg'),
                      ),
                    ),
                    SizedBox(height: 5,),
                    Text('Dr , Muhammad Abul Majd',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                    SizedBox(height: 5,),
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Muhammad_Abul_Majd_chat()));
                            ...
                            CircleAvatar(
                              ...
                              backgroundColor: Colors.blue,
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Muhammad_Abul_Majd_resevation()));
