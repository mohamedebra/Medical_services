...
import 'package:medical_services/Screens/chat/chats_doctors/inside/Talaat_Al-Lisi_chat.dart';
import 'package:medical_services/Screens/reservation/reservation_inside/reservation_Talaat_Al_Lisi.dart';
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5,),
                    Text('Dr , Talaat Al-Lisi',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                    SizedBox(height: 5,),
                    ...
                    Text('11:00 PM  - 7:00 PM   ',style: TextStyle(
                        fontSize: 15,
                        color: Colors.blue
                    ),),
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Talaat_Al_Lisi_chat()));
                            ...
                            CircleAvatar(
                              ...
                              backgroundColor: Colors.blue,
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Reservation_Talaat_Al_Lisi()));
