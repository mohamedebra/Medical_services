...
import 'package:medical_services/Screens/chat/chats_doctors/inside/Amani_Abd_al-Maqsud_chat.dart';
import 'package:medical_services/Screens/reservation/reservation_inside/resernation_Amani_Abd_al_Maqsud.dart';
                ...
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: CircleAvatar(
                        radius: 45,
                        backgroundImage: AssetImage('images/اماني عبد المقصود.jpg'),
                      ),
                    ),
                    SizedBox(height: 5,),
                    Text('Dr , Amani Abd al-Maqsud Shulgami',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                    SizedBox(height: 5,),
                    ...
                    Text('8:00 PM  - 10:00 PM   ',style: TextStyle(
                        fontSize: 15,
                        color: Colors.blue
                    ),),
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Amani_Abd_al_Maqsud_chat()));
                            ...
                            CircleAvatar(
                              ...
                              backgroundColor: Colors.blue,
                              child:    IconButton(onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Reservation_Amani_Abd_al_Maqsud()));
