...
class Curriculum_Vitae_doctor6_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr ,  Ahmed El-Sayed',style: TextStyle(fontSize: 20),)
                ],
              ),
            ),
            body: Padding(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr ,  Ahmed El-Sayed Tawfiq'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
