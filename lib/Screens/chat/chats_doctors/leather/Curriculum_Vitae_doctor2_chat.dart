...
class Curriculum_Vitae_doctor2_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr ,  Samar Hossam',style: TextStyle(fontSize: 20),)
                ],
              ),
            ),
            body: Padding(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr ,  Samar Hossam Omar'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
