...
class Curriculum_Vitae_doctor1_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr , Ahmed Mohamed',style: TextStyle(fontSize: 20),)
                ],
              ),
            ),
            body: Padding(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr , Ahmed Mohamed'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
