...
class Reem_Abdel_Moneim_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr , Reem Abdel Moneim',style: TextStyle(fontSize: 20),)
                ],
              ),
            ),
            body: Padding(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr , Reem Abdel Moneim'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
