...
class Amani_Abd_al_Maqsud_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr , Amani Abd al-Maqsud',style: TextStyle(fontSize: 20),)
                ],
              ),
            ),
            body: Padding(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr , Amani Abd al-Maqsud'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
