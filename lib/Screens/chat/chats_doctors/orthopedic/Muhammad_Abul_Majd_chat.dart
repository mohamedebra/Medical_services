...
class Muhammad_Abul_Majd_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr , Muhammad Abul Majd',style: TextStyle(fontSize: 18),
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr , Muhammad Abul Majd'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
