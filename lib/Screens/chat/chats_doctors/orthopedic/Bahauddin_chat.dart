...
class Bahauddin_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr , Bahauddin Saeed',style: TextStyle(fontSize: 20),)
                ],
              ),
            ),
            body: Padding(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr , Bahauddin Saeed Al-Khudari'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
