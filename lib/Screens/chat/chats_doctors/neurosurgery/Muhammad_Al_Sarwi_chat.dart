...
class Muhammad_Al_Sarwi_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr ,  Muhammad Al-Sarwi',style: TextStyle(fontSize: 20),)
                ],
              ),
            ),
            body: Padding(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr ,  Muhammad Al-Sarwi'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
