...
class Curriculum_Vitae_doctor3_chat extends StatelessWidget {
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Dr , Tariq Abdul Ghani',style: TextStyle(fontSize: 20),)
                ],
              ),
            ),
            body: Padding(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Welcome my name Dr , Tariq Abdul Ghani'),
                    ),
                  ),
                  SizedBox(height: 15,),
                  Align(
