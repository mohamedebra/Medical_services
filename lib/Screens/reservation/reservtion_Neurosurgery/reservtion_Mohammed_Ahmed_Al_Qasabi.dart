...
import 'package:medical_services/Screens/search/card.dart';
import 'package:medical_services/model/lang.dart';
import 'package:medical_services/style/style.dart';

class Reservation_Mohammed_Ahmed_Al_Qasabid extends StatelessWidget {
  Lang _lang = Lang();
            ...
            SingleChildScrollView(
              child: Form(
                ...
                child: Column(
                  children: [
                    SizedBox(height: 5,),
                    Text('Dr ,  Mohammed Ahmed Al-Qasabi',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.blue),),
                    const SizedBox(
                      height: 35,
                    ),
                    Padding(
