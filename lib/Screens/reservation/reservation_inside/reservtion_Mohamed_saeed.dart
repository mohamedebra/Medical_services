...
class Reservation_Mohamed_saeed extends StatelessWidget {
  Lang _lang = Lang();
            ...
            SingleChildScrollView(
              child: Form(
                ...
                child: Column(
                  children: [
                    SizedBox(height: 5,),
                    Text('Dr , Muhammad Saeed Rushdi',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.blue),),
                    const SizedBox(
                      height: 35,
                    ),
                    Padding(
