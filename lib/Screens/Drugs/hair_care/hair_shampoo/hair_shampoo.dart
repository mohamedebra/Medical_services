...
class hair_shampoo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_lang.getHairshampoo(),style: TextStyle(fontSize: 20),),
      ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            'شامبو ضد القشره وضد التساقط الشعر للرجال '),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/هيد .jpg'),width: 120,height: 120,),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/بانتين .jpg'),width: 120,height: 120,),
                        Text(
                            'بانتين شامبو ناعم وحريري 200 ملل'),
                        Text(
                          'عبله',style: TextStyle(color: Colors.grey[300]),),
                        Text(
                            '49 جنيه'),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/لوريال.jpg'),width: 120,height: 120,),
                        Text(
                            'لوريال باريس الفيف اكستروردنري اويل شامبو مغذي '),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/سباركل.jpg'),width: 120,height: 120,),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/لوريال باريس.jpg'),width: 120,height: 120,),
                        Text(
