...
class Common_symptomatic_treatments extends StatefulWidget {
  ...
  @override
  State<Common_symptomatic_treatments> createState() => _Common_symptomatic_treatmentsState();
}

class _Common_symptomatic_treatmentsState extends State<Common_symptomatic_treatments> {
  Lang _lang = Lang();
   List  business = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_lang.getCommonsymptomatictreatments(),style: TextStyle(fontSize: 20),),
      ),
                            ...
                            child: Column(
                              children: [
                                ...
                                InkWell(
                                  onTap: (){
                                    for(var i = 0 ; i >= 100; i++)
                                    ModelLogin.buyprodact(product_id: business[i]['id']);
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Image(
                                  image: NetworkImage('${business[8]['image']}'),width: 120,height: 120,),
                                Text(
                                    '${business[8]['name']}'),
                                Text(
                                  'عبله',style: TextStyle(color: Colors.grey[300]),),
                                Text(
                                    '${business[8]['price']} جنيه'),
                                InkWell(
                                  onTap: (){
                                    for(var i = 0 ; i >= 100; i++)
                                      ModelLogin.buyprodact(product_id: business[i]['id']);
