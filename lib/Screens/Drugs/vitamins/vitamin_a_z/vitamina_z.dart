...
class Vitamina_z extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_lang.getVitaminsfromAtoZ(),style: TextStyle(fontSize: 20),),
      ),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/دافاليندي.jpg'),width: 120,height: 120,),
                        Text(
                            'دافاليندي 10000 وحده دوليه 30 قرص'),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/فيدروب.jpg'),width: 120,height: 120,),
                        Text(
                            'فيدروب 2800 وحده دوليه نقط بالفم 15 مل'),
                        Text(
                          'عبله',style: TextStyle(color: Colors.grey[300]),),
                        const Text(
                            '16 جنيه'),
