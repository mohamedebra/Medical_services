...
class Alcohol_and_sterilization extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_lang.getAlcoholandsterilization(),style: TextStyle(fontSize: 20),),
      ),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/بيستر.jpg'),width: 120,height: 120,),
                        Text(
                            'بيستر يليانت مطهر طبي وجراحي 1000 ملل'),
                        Text(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/ستيريليوم.jpg'),width: 120,height: 120,),
                        Text(
                            'ستيريليوم جل لليدين ١ لتر '),
                        Text(
                          'عبله',style: TextStyle(color: Colors.grey[300]),),
                        Text(
                            '90 جنيه'),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/جل ايفا.jpg'),width: 120,height: 120,),
                        Text(
                            'جل ايفا المضاد للبكتيريا ٧٠٪ كحول ٣٥٠ مل'),
                        Text(
                          'عبله',style: TextStyle(color: Colors.grey[300]),),
                        Text(
                            '69 جنيه'),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('images/روزماكس.jpg'),width: 120,height: 120,),
                        Text(
                            'روزماكس جهاز نيبوليزر '),
                        Text(
                          'عبله',style: TextStyle(color: Colors.grey[300]),),
                        Text(
                            '950 جنيه'),
